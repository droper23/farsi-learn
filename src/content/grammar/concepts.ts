...
export const grammarConcepts: GrammarConcept[] = [
  ...
  },
  {
    ...
    note: 'Confirmed against MSU OpenBooks "Basic Persian" and general Persian-grammar references: Persian reported speech is not obligated to backshift the way English is, particularly for present/future-referring verbs.',
    confidence: 'verified',
  },
  {
  ...
  },
  {
    ...
    note: 'Each pairing confirmed against general Persian-usage references (Colloquial Persian course materials, persianwithel.com) as the standard spoken form used across virtually all of Iran: mikhāham→mikhām, miāyad→miyād, khāne→khune, nemidānam→nemidunam are all well-attested, non-regional-fringe contractions.',
    confidence: 'verified',
  },
  {
  ...
  {
    id: 'g-imperfect-past', title: 'Habitual/continuous past: می‌ + past stem', category: 'past-tense', level: 5, order: 27,
    explanation: [
      'Adding می‌ to the past stem (the same prefix used for the simple present) turns a one-time simple past into a habitual or ongoing past action: رفتم "I went" (once) vs. می‌رفتم "I used to go / I was going" (repeatedly, or in progress).',
      'This is also the tense Persian narrators use for background description in stories, switching to the plain simple past for the main sequence of events.',
    ],
    exampleSentenceIds: ['s-imperfect-habitual', 's-imperfect-child'],
    relatedConceptIds: ['g-simple-past', 'g-present-tense-verbs'],
    commonMistake: 'Using the simple past (رفتم) for a habitual/repeated action, which reads as one single completed event instead.',
    note: 'Confirmed against Settemila Lingue "Past Imperfect (Continuous Past)" and "A Guide to Persian Verbs" (Past Imperfect entry): می- + past stem + personal ending, used for habitual/ongoing past actions and as the Persian narrative-background tense.',
    confidence: 'verified',
  },
  {
    id: 'g-concessive-clauses', title: 'Concessive clauses: اگرچه / هرچند ("although")', category: 'conjunctions', level: 5, order: 28,
    explanation: [
      'اگرچه (agarche) and هرچند (harchand) both mean "although / even though" and introduce a clause that stays true despite the main clause — unlike اگر ("if") conditionals, the concessive clause is a plain fact, not a hypothetical, so it takes the ordinary indicative, not the subjunctive.',
      'اگرچه هوا سرد بود، بیرون رفتیم "Although the weather was cold, we went outside" — the cold weather is a stated fact, not a condition.',
    ],
    exampleSentenceIds: ['s-concessive-cold'],
    relatedConceptIds: ['g-conditionals'],
    commonMistake: 'Treating اگرچه like اگر and reaching for the subjunctive — concessive clauses use the normal indicative tense.',
    note: 'Confirmed against dastur.info §16 Conjunctions and §18.4 Adverbial Clauses: اگرچه/هرچند as the standard concessive conjunctions, taking the indicative mood.',
    confidence: 'verified',
  },
  {
    id: 'g-causal-clauses', title: 'Causal clauses: چون / زیرا ("because")', category: 'conjunctions', level: 5, order: 29,
    explanation: [
      'چون (chon) is the everyday word for "because", introducing the reason for the main clause: چون خسته بودم، زود خوابیدم "Because I was tired, I went to sleep early." زیرا (zirā) is a more formal/written synonym.',
      'چون can also be followed by که (چون که) with no change in meaning, especially in speech.',
    ],
    exampleSentenceIds: ['s-causal-tired'],
    relatedConceptIds: ['g-relative-clauses'],
    note: 'Confirmed against dastur.info §16 Conjunctions: چون / چرا / زیرا listed as the core Persian causal conjunctions, چون as the default everyday choice.',
    confidence: 'verified',
  },
  {
    id: 'g-purpose-clauses', title: 'Purpose clauses: تا + subjunctive ("in order to")', category: 'subjunctive', level: 5, order: 30,
    explanation: [
      'تا (tā) followed by a subjunctive verb means "in order to / so that": من زود می‌روم تا به ترافیک نخورم "I\'m leaving early so that I don\'t hit traffic." — the subjunctive (ب- prefix or, in the negative, نـ + no می‌) is required here regardless of the main clause\'s own tense.',
      'This is a different تا from the "until" sense (تا فردا صبر کن "wait until tomorrow") — context distinguishes them, but the subjunctive-triggering purpose sense is the one that matters grammatically.',
    ],
    exampleSentenceIds: ['s-purpose-traffic', 's-purpose-class'],
    relatedConceptIds: ['g-subjunctive'],
    commonMistake: 'Using the indicative/present tense after purpose تا instead of the subjunctive.',
    note: 'Confirmed against UT Austin Persian Online (Present Subjunctive) and MSU OpenBooks §8.7 Subjunctive: تا + subjunctive for purpose clauses, including a near-identical example sentence (تا به ترافیک نخورم).',
    confidence: 'verified',
  },
]
