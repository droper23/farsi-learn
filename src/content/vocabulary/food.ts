...
export const foodVocab: VocabItem[] = [
  ...
  { id: 'food-goshnam', fa: 'گشنمه', translit: 'goshname', en: "I'm hungry", pos: 'phrase', category: 'restaurant', register: 'colloquial', frequency: 1, level: 1, altEn: ['گرسنه‌ام (gorosne-am) is the formal equivalent.'], confidence: 'verified', note: 'Confirmed via Abadis (گرسنه/گشنه entries) that گشنه is the colloquial/dialectal synonym of گرسنه, so گشنمه = گشنه‌ام is the standard spoken contraction for "I\'m hungry".' },
  { id: 'food-tashnamme', fa: 'تشنمه', translit: 'teshname', en: "I'm thirsty", pos: 'phrase', category: 'restaurant', register: 'colloquial', frequency: 1, level: 1, altEn: ['تشنه‌ام (teshne-am) is the formal equivalent.'], confidence: 'verified', note: 'Confirmed as the everyday Tehrani colloquial contraction of تشنه‌ام ("I am thirsty") via general Persian usage sources; spelling and register match how the word appears in casual written Persian (chat/song lyrics).' },
