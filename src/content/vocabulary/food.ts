...
export const foodVocab: VocabItem[] = [
  ...
  { id: 'food-garson', fa: 'گارسون', translit: 'gārson', en: 'waiter / server', pos: 'noun', category: 'restaurant', register: 'neutral', frequency: 2, level: 1, notes: 'Loanword from French garçon; the everyday word for a restaurant server regardless of gender.', confidence: 'high-confidence' },
  { id: 'food-sefaresh', fa: 'سفارش', translit: 'sefāresh', en: 'order (at a restaurant)', pos: 'noun', category: 'restaurant', register: 'neutral', frequency: 2, level: 2, notes: 'سفارش دادن (sefāresh dādan) = "to order/place an order".', confidence: 'high-confidence' },
  { id: 'food-nushidani', fa: 'نوشیدنی', translit: 'nushidani', en: 'beverage / drink', pos: 'noun', category: 'restaurant', register: 'neutral', frequency: 2, level: 1, confidence: 'high-confidence' },
]
