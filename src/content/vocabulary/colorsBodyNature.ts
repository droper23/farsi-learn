...
export const bodyVocab: VocabItem[] = [
  ...
  { id: 'body-bini', fa: 'بینی', translit: 'bini', en: 'nose', pos: 'noun', category: 'body', register: 'neutral', frequency: 2, level: 2, altEn: ['دماغ (damāgh) is the everyday colloquial word for "nose".'], confidence: 'verified' },
  { id: 'body-mo', fa: 'مو', translit: 'mu', en: 'hair', pos: 'noun', category: 'body', register: 'neutral', frequency: 2, level: 2, pluralFa: 'موها', notes: 'مو also means "grapevine" (its primary dictionary sense) — an unrelated homograph, distinguished by context, similar to شیر "milk/lion".', confidence: 'verified' },
]
...
export const natureVocab: VocabItem[] = [
  ...
  { id: 'nat-rudkhane', fa: 'رودخانه', translit: 'rudkhāne', en: 'river', pos: 'noun', category: 'nature', register: 'neutral', frequency: 2, level: 1, confidence: 'high-confidence' },
  { id: 'nat-jangal', fa: 'جنگل', translit: 'jangal', en: 'forest', pos: 'noun', category: 'nature', register: 'neutral', frequency: 2, level: 1, confidence: 'high-confidence' },
  { id: 'nat-aseman', fa: 'آسمان', translit: 'āsemān', en: 'sky', pos: 'noun', category: 'nature', register: 'neutral', frequency: 1, level: 1, confidence: 'high-confidence' },
  { id: 'nat-daryache', fa: 'دریاچه', translit: 'daryāche', en: 'lake', pos: 'noun', category: 'nature', register: 'neutral', frequency: 2, level: 1, literalEn: 'little sea', confidence: 'high-confidence' },
  { id: 'nat-sang', fa: 'سنگ', translit: 'sang', en: 'stone / rock', pos: 'noun', category: 'nature', register: 'neutral', frequency: 2, level: 1, confidence: 'high-confidence' },
  { id: 'nat-barg', fa: 'برگ', translit: 'barg', en: 'leaf', pos: 'noun', category: 'nature', register: 'neutral', frequency: 2, level: 1, confidence: 'high-confidence' },
  { id: 'nat-heyvan', fa: 'حیوان', translit: 'heyvān', en: 'animal', pos: 'noun', category: 'nature', register: 'neutral', frequency: 2, level: 1, confidence: 'high-confidence' },
  { id: 'nat-sag', fa: 'سگ', translit: 'sag', en: 'dog', pos: 'noun', category: 'nature', register: 'neutral', frequency: 2, level: 1, confidence: 'high-confidence' },
  ...
  { id: 'nat-havasarde', fa: 'هوا سرد است', translit: 'havā sard ast', en: "it's cold out", pos: 'phrase', category: 'weather', register: 'neutral', frequency: 1, level: 1, confidence: 'verified' },
  { id: 'nat-aftab', fa: 'آفتاب', translit: 'āftāb', en: 'sun / sunshine', pos: 'noun', category: 'weather', register: 'neutral', frequency: 1, level: 1, altEn: ['آفتابی است (āftābi ast) = "it is sunny".'], confidence: 'verified' },
  { id: 'nat-abr', fa: 'ابر', translit: 'abr', en: 'cloud', pos: 'noun', category: 'weather', register: 'neutral', frequency: 2, level: 1, altEn: ['ابری است (abri ast) = "it is cloudy".'], confidence: 'verified' },
  { id: 'nat-dama', fa: 'دما', translit: 'damā', en: 'temperature', pos: 'noun', category: 'weather', register: 'neutral', frequency: 2, level: 2, confidence: 'verified' },
]
