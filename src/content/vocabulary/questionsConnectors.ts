...
export const questionWordsVocab: VocabItem[] = [
  ...
  { id: 'q-ki-who', fa: 'کی', translit: 'ki', en: 'who', pos: 'question-word', category: 'question-words', register: 'neutral', frequency: 1, level: 1, notes: 'Careful: کی also means "when" — context (or stress) tells them apart; چه کسی (che kasi) is the unambiguous formal "who".', note: 'Confirmed against Dehkhoda (via vajehyab.com) and Abadis: کی is listed with both senses — "چه وقت" (when) and "چه کس/کدام کس" (who), disambiguated by context; چه کسی remains the unambiguous formal alternative.', confidence: 'verified' },
