...
export const shoppingVocab: VocabItem[] = [
  ...
  { id: 'shop-gerooneh', fa: 'گرونه', translit: 'gerune', en: "it's expensive (colloquial)", pos: 'phrase', category: 'shopping', register: 'colloquial', frequency: 2, level: 1, altEn: ['گران است (gerān ast) is the formal form.'], confidence: 'needs-review', note: 'Colloquial contraction of گران است — spot-check exact casual register.' },
